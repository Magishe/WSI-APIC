...
Sample_Name_List = ["WU1001","WU1002","WU1003","WU1004","WU1005","WU2001","WU2002","WU2003","WU2004","WU2005"]
for samplei in [2]:
    image_file = "C:/Users\shizh\OneDrive - California Institute of Technology\Fast Scanner/NSCLC.tif"
    img_ori = cv2.imread(image_file)
    # cv2.imwrite('binary_image.png',black_image*255)
    # np.save("dogs_embedding.npy", image_embedding)

    h1,h2,l1,l2 = Calculate_Boundary(img_ori)
    checkpoint = "C:/Users\shizh\OneDrive - California Institute of Technology\Fast Scanner\sam_vit_h_4b8939.pth"
    model_type = "vit_h"
